...
import { ErrorOutlineIcon, InfoOutlineIcon, RetryIcon, CheckmarkCircleIcon, RetrieveIcon, ChevronLeftIcon, ChevronRightIcon, SyncIcon, SortIcon, DownloadIcon, ResetIcon, UploadIcon, TranslateIcon, AddIcon, ChevronUpIcon, ChevronDownIcon, TrashIcon, EditIcon, WarningOutlineIcon, PublishIcon, DocumentIcon, RevertIcon, SearchIcon, ClockIcon, CropIcon, CalendarIcon, TagIcon, CheckmarkIcon, LockIcon, PlayIcon, PlugIcon, EllipsisHorizontalIcon, ImageIcon, WarningFilledIcon, DocumentVideoIcon } from "@sanity/icons";
...
const DialogStateContext = createContext({
  ...
  setDialogState,
  children
}) => /* @__PURE__ */ jsx(DialogStateContext.Provider, { value: { dialogState, setDialogState }, children }), useDialogStateContext = () => useContext(DialogStateContext), mimeExtGraph = [
  /* Audio */
  ["audio/x-aiff", "aif"],
  ["audio/x-aiff", "aiff"],
  ["audio/basic", "au"],
...
function DownloadAssetDialog({ asset, onClose, absolute }) {
  ...
  return useEffect(() => {
    ...
    Dialog,
    {
      ...
      children: /* @__PURE__ */ jsxs(Stack, { paddingX: 5, paddingY: 3, children: [
        /* @__PURE__ */ jsx(Text, { hidden: status !== "preparing", align: "center", children: "Your download file is being prepared\u2026" }),
        /* @__PURE__ */ jsx(Text, { hidden: status !== "success", align: "center", children: "Your download file is ready." }),
        /* @__PURE__ */ jsx(Text, { hidden: status !== "error", align: "center", children: "Something went wrong during preparation :/" })
      ] })
    }
  );
}
...
function VideoPlayer({
  ...
  return isAudio && (aspectRatio = props.forceAspectRatio ? (
    ...
    dialogState === "download-asset" && /* @__PURE__ */ jsx(DownloadAssetDialog, { asset })
  ] });
}
  ...
  return useEffect(() => {
    ...
    Dialog,
    {
      ...
      children: [
        ...
        state === "downloading" && /* @__PURE__ */ jsx(
          DownloadAssetDialog,
          {
            asset: props.asset,
