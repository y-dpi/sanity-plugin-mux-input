...
import type {MuxInputProps, VideoAssetDocument, PluginConfig} from '../util/types'
...
export default function SelectAssets({asset: selectedAsset, onChange, setDialogState, config}: Props) {
